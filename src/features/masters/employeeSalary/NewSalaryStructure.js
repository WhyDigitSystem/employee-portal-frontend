...
const NewSalaryStructure = ({ newSalary }) => {
  ...
  const [newSalaryStructureTableEarnings, setNewSalaryStructureTableEarnings] =
    useState([
      {
        id: 1,
        heading: "",
  ...
  const handleInputChange = (e) => {
    ...
    if (errorMessage) {
      ...
      //   // Call getAllEmployeeNames when month or year is selected
      //   if (name === "month" || name === "year") {
      //     getAllEmployeeNames(updatedFormData.month, updatedFormData.year);
      //   }
    ...
    if (table === newSalaryStructureTable) {
      setSalaryStructureTableErrors((prevErrors) => {
        ...
        newErrors[table.length - 1] = {
          ...newErrors[table.length - 1],
          heading: !table[table.length - 1].heading
            ? "Heading is required"
            : "",
  ...
  const handleDeleteRowDetections = (
    id,
    table,
    setTable,
    errorTable,
  ...
  const handleSave = () => {
    ...
    if (handleValidation()) {
      ...
      const dataToSave = {
        ...
        salaryStructureEarningsDTO: newSalaryStructureTableEarnings.map(
          (earning) => ({
            heading: earning.heading,
            amount: parseInt(earning.amount),
          })
        ),
        salaryStructureDeductionDTO: newSalaryStructureTable.map(
          (deduction) => ({
        ...
        <div className="card w-full p-6 bg-base-100 shadow-xl">
          <div className="row d-flex justify-content-center align-items-center">
            <div className="d-flex justify-content-between">
              <h1 className="text-xl font-semibold mb-3">Salary Structure</h1>
              <IoMdClose
                type="button"
                  ...
                  onChange={(event, newValue) => {
                    if (newValue) {
                      setFormData({
                        ...
                        employeeCode: newValue.empCode,
                        dob: newValue.DOB,
                        doj: newValue.joiningDate,
                        panNo: newValue.pan,
                        position: newValue.designation,
                        bankAccountNo: newValue.accountNo,
                        department: newValue.department,
                        grade: newValue.grade,
                        totalDays: newValue.totalDays,
                        lop: newValue.lop,
                        pan: newValue.pan,
                        uan: newValue.uan,
                        location: newValue.branch,
                ...
                <FormControl fullWidth>
                  <LocalizationProvider dateAdapter={AdapterDayjs}>
                    <DatePicker
                      ...
                      disabled
                      value={
                        formData.dob ? dayjs(formData.dob, "YYYY-MM-DD") : null
                      }
                ...
                <FormControl fullWidth>
                  <LocalizationProvider dateAdapter={AdapterDayjs}>
                    <DatePicker
                      ...
                      disabled
                      value={
                        formData.doj ? dayjs(formData.doj, "YYYY-MM-DD") : null
                      }
                      ...
                      <div className="table-responsive">
                        <table className="table table-bordered ">
                          <thead>
                            <tr>
                              <th
                                className="table-header px-2 py-2 text-center"
                                style={{ width: "10px" }}
                              >
                                Action
                              </th>
                          ...
                          <tbody>
                            {/* {newSalaryStructureTableEarnings.map( */}
                            {newSalaryStructureTableEarnings?.map ? (
                              newSalaryStructureTableEarnings.map(
                                (row, index) => (
                                  // (row, index) => (
                                  <tr key={row.id}>
                                    ...
                                    <td>
                                      <Autocomplete
                                        ...
                                        groupBy={(option) =>
                                          option.headings
                                            ? option.headings[0].toUpperCase()
                                            : ""
                                        }
                                        value={
                                          row.heading
                                            ? listAllHeadingEarning.find(
                                                (a) =>
                                                  a.headings === row.heading
                                              )
                                            : null
                                        }
                                        onChange={(event, newValue) => {
                                    ...
                                    <td className="border px-2 py-2">
                                      ...
                                      />
                                      {salaryStructureTableEarningsErrors[index]
                                        ?.amount && (
                                        <div
                                          className="mt-2"
                                          style={{
                                ...
                                <tr key={row.id}>
                                  ...
                                  <td>
                                    <Autocomplete
                                      ...
                                      value={
                                        row.heading
                                          ? listAllHeadingDeduction.find(
                                              (a) => a.headings === row.heading
                                            )
                                          : null
                                      }
                                      onChange={(event, newValue) => {
                                      ...
                                      renderInput={(params) => (
                                        <TextField
                                          ...
                                          variant="outlined"
                                          error={
                                            !!salaryStructureTableErrors[index]
                                              ?.heading
                                          }
                                          helperText={
                                            salaryStructureTableErrors[index]
